...
declare const Controller: <TAs extends React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | React.ComponentClass<any, any> | React.FunctionComponent<any> | "input" | "select" | "textarea", TControl extends Control<Record<string, any>> = Control<Record<string, any>>>({ name, rules, as, render, defaultValue, control, onFocus, ...rest }: import("react-hook-form/dist/types/utils").Assign<{
    name: import("react-hook-form/dist/types/form").FieldName<import("react-hook-form/dist/types/form").FieldValuesFromControl<TControl>>;
    as?: TAs | undefined;
    rules?: Partial<{
        required: string | boolean | import("react-hook-form/dist/types/form").ValidationValueMessage<boolean>;
        min: import("react-hook-form/dist/types/form").ValidationRule<React.ReactText>;
        max: import("react-hook-form/dist/types/form").ValidationRule<React.ReactText>;
        maxLength: import("react-hook-form/dist/types/form").ValidationRule<React.ReactText>;
        minLength: import("react-hook-form/dist/types/form").ValidationRule<React.ReactText>;
        pattern: import("react-hook-form/dist/types/form").ValidationRule<RegExp>;
        validate: import("react-hook-form/dist/types/form").Validate | Record<string, import("react-hook-form/dist/types/form").Validate>;
    }> | undefined;
